...
public class LWSHorizontalView extends ViewGroup {
    private int lastX;
    private int lastY;
    ...
    public LWSHorizontalView(Context context) {
        super(context);
        init();
    }
    public LWSHorizontalView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    public LWSHorizontalView(Context context, AttributeSet attrs, int defStyleAttr) {
